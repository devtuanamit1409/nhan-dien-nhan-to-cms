"use strict";(self.webpackChunkcms_nhan_dien_to_chuc=self.webpackChunkcms_nhan_dien_to_chuc||[]).push([[6837],{40216:(rt,U,s)=>{s.d(U,{S:()=>$});var t=s(92132),_=s(63891),p=s(94061),X=s(48653),f=s(83997),S=s(30893);const F=(0,_.default)(p.a)`
  height: ${24/16}rem;
  width: ${24/16}rem;
  border-radius: 50%;
  display: flex;
...
`,N=(0,_.default)(p.a)`
  ...
  width: 100%;
  border: none;
`,$=({children:x,icon:G,...z})=>(0,t.jsxs)("div",{children:[(0,t.jsx)(X.c,{}),(0,t.jsx)(N,{as:"button",background:"primary100",padding:5,...z,children:(0,t.jsxs)(f.s,{children:[(0,t.jsx)(F,{"aria-hidden":!0,background:"primary200",children:G}),(0,t.jsx)(p.a,{paddingLeft:3,children:(0,t.jsx)(S.o,{variant:"pi",fontWeight:"bold",textColor:"primary600",children:x})})]})})]})},96837:(rt,U,s)=>{s.r(U),s.d(U,{default:()=>Nt});var t=s(92132),_=s(94061),p=s(83997),X=s(58805),f=s(30893),S=s(35513),F=s(26127),N=s(90361),$=s(33363),x=s(85963),G=s(40216),z=s(88353),dt=s(55356),ct=s(4198),d=s(55506),ht=s(68802),R=s(5194),Q=s(41909),_t=s(50612),pt=s(41231),ut=s(77701),gt=s(54514),mt=s(46270),j=s(2600),ft=s(412),J=s(56336),Y=s(39404),I=s(54894),w=s(17703),W=s(21272),r=s(75119),E=s(63891),kt=s(14718),Zt=s(74327),Vt=s(48940),Xt=s(77160),Gt=s(21835),wt=s(17024),Ht=s(51187),Qt=s(12083),Jt=s(94710),Yt=s(14311),qt=s(82437),te=s(89102),ee=s(5409),se=s(35336),ne=s(71547),oe=s(58692),ae=s(71210),ie=s(5790),le=s(35223),re=s(45635);const Et=(0,E.default)(_.a)`
  table {
    width: 100%;
    white-space: nowrap;
  }
...
`,tt=({customRowComponent:e,component:n,isFromDynamicZone:o=!1,isNestedInDZComponent:a=!1,firstLoopComponentUid:c})=>{const{modifiedData:l}=(0,r.u)(),{schema:{attributes:u}}=j(l,["components",n],{schema:{attributes:[]}});return(0,t.jsx)(q,{isChildOfDynamicZone:o,className:"component-row",children:(0,t.jsx)("td",{colSpan:12,children:(0,t.jsx)(st,{customRowComponent:e,items:u,targetUid:n,firstLoopComponentUid:c||n,editTarget:"components",isFromDynamicZone:o,isNestedInDZComponent:a,isSub:!0,secondLoopComponentUid:c?n:null})})})},xt=({isActive:e=!1,icon:n="cube"})=>(0,t.jsx)(p.s,{alignItems:"center",background:e?"primary200":"neutral200",justifyContent:"center",height:8,width:8,borderRadius:"50%",children:(0,t.jsx)(X.I,{as:r.C[n]||r.C.cube,height:5,width:5})}),et=(0,E.default)(_.a)`
  position: absolute;
  display: none;
  top: 5px;
  right: ${(0,d.a8)(8)};
